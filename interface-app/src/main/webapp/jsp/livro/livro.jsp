                        ...
                        <td>
                            <% if (livro.getAutores() != null){%>
                                ...
                                <% for (Autor autor: livro.getAutores()){ %>
                                    <li class="list-group-item"><%= autor.getNome() %></li>
                                <% }%>
                                </ul>
                            <%}%>
                        </td>
                        <td>
                            <a class="btn btn-success" href="../../jsp/livro/update.jsp?livroId=<%= livro.getId() %>"><i class="fas fa-edit"></i></a>
                            <a class="btn btn-danger" href="../../process/livro/livro-delete.jsp?livroId=<%= livro.getId() %>"><i class="far fa-trash-alt"></i></a>
                        </td>
                    </tr>
                <%  } %>
                </tbody>
